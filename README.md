...
Mestranda no Programa de Pós-Graduação em Engenharia Elétrica e de Computação (PPGEEC/UFC), onde atuo como bolsista pesquisadora em Inteligência Artificial, Machine Learning, Deep Learning e Visão Computacional. Possuo grande interesse na área de Ciências de Dados, desenvolvendo projetos utilizando diversas ferramentas e bibliotecas. Estou constantemente buscando aprimorar minhas habilidades e aplicar o conhecimento adquirido para resolver desafios.
